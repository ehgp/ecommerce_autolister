...
PAGES = cf["EBAY_WEBSCRAPER_PARAMS"]["PAGES"]

EBAY_LOGIN = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_LOGIN"]

EBAY_USERNAME_XPATH = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_USERNAME_XPATH"]

EBAY_PASSWORD_XPATH = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_PASSWORD_XPATH"]

EBAY_LOGIN_BUTTON_XPATH = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_LOGIN_BUTTON_XPATH"]

EBAY_SOUP_LINK_FINDALL_EXT = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_SOUP_LINK_FINDALL_EXT"]

EBAY_SOUP_TITLE_EXT = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_SOUP_TITLE_EXT"]

EBAY_SOUP_DES_EXT = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_SOUP_DES_EXT"]

EBAY_SOUP_PRICE_EXT = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_SOUP_PRICE_EXT"]

EBAY_SOUP_SHIPPRICE_EXT = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_SOUP_SHIPPRICE_EXT"]

EBAY_SOUP_SHIPHOW_EXT = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_SOUP_SHIPHOW_EXT"]

EBAY_LINK_LIST = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_LINK_LIST"]

EBAY_SOUP_IMAGELINK_96_EXT = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_SOUP_IMAGELINK_96_EXT"]

EBAY_SOUP_IMAGELINK_300_EXT = cf["EBAY_WEBSCRAPER_PARAMS"][
    "EBAY_SOUP_IMAGELINK_300_EXT"
]

EBAY_SOUP_IMAGELINK_64_EXT = cf["EBAY_WEBSCRAPER_PARAMS"]["EBAY_SOUP_IMAGELINK_64_EXT"]
